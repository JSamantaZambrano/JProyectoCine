...
public class Peliculas implements Serializable {
    ...
    @OneToOne(mappedBy = "idPelicula")
    private PeliculasActor peliculasActor;
    ...
    public PeliculasActor getPeliculasActor() {
        return peliculasActor;
    }

    public void setPeliculasActor(PeliculasActor peliculasActor) {
